  ...
  <main>
    ...
    <div class="container">
      <div class="row ">
        ...
        <div class="col text-center p-0">
          <a type="button" class="w-100 btn btn-lg btn-outline-primary p-10 m-10" style='cursor:not-allowed'>Pesan</a>
        </div>
        <div class="col text-center p-0">
          <a type="button" class="w-100 btn btn-lg btn-outline-primary p-10 m-10" style='cursor:not-allowed'>Bayar</a>
        </div>
      </div>
    </div>
    <!-- List Mobil -->
